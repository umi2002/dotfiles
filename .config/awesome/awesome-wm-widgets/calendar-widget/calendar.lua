...
local function worker(user_args)
    ...
    local calendar_themes = {
        custom = {
            bg = theme.bg_normal,
            fg = theme.fg_normal,
            focus_date_bg = theme.border_normal,
            focus_date_fg = theme.fg_normal,
            weekend_day_bg = theme.bg_normal,
            weekday_fg = theme.fg_normal,
    ...
    local theme_ = args.theme or 'naughty'
    ...
    styles.month = {
        padding = 4,
        bg_color = calendar_themes[theme_].bg,
        border_width = 0,
    }
    ...
    styles.focus = {
        fg_color = calendar_themes[theme_].focus_date_fg,
        bg_color = calendar_themes[theme_].focus_date_bg,
        markup = function(t) return '<b>' .. t .. '</b>' end,
        shape = rounded_shape(4)
    }

    styles.header = {
        fg_color = calendar_themes[theme_].header_fg,
        bg_color = calendar_themes[theme_].bg,
        markup = function(t) return '<b>' .. t .. '</b>' end
    }

    styles.weekday = {
        fg_color = calendar_themes[theme_].weekday_fg,
        bg_color = calendar_themes[theme_].bg,
        markup = function(t) return '<b>' .. t .. '</b>' end,
    }
    ...
    local function decorate_cell(widget, flag, date)
        ...
        local default_bg = (weekday == 0 or weekday == 6)
            and calendar_themes[theme_].weekend_day_bg
            or calendar_themes[theme_].bg
        local ret = wibox.widget {
            ...
            fg = props.fg_color or calendar_themes[theme_].fg,
    ...
    local popup = awful.popup {
        ...
        offset = { y = 5 },
        border_width = 2,
        border_color = calendar_themes[theme_].border,
        opacity = 0.7,
        widget = cal,
