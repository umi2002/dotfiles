...
local function worker(user_args)
    ...
    play_pause.font = font
    play_pause.align = 'center'
    play_pause.forced_width = 30
    ...
    spotify_widget = wibox.widget {
        ...
        set_status = function(self, is_playing)
            ...
            if dim_when_paused then
                ...
                self:get_children_by_id('separator')[1]:set_opacity(is_playing and 1 or dim_opacity)
                self:get_children_by_id('separator')[1]:emit_signal('widget::redraw_needed')
    ...
    local update_widget_text = function(widget, stdout, _, _, _)
        ...
        if album ~= nil and title ~= nil and artist ~= nil then
            ...
            widget:set_text(artist, title .. " 󰎈 ")
