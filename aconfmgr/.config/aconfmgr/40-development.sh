#!/bin/bash
# ~/.config/aconfmgr/40-development.sh
...
AddPackage --foreign local-lua-debugger-vscode-git # A simple Lua debugger which requires no additional dependencies.
AddPackage bear # A tool to generate compilation database for clang tooling
AddPackage cmake # A cross-platform open-source make system
AddPackage gdb # The GNU Debugger
AddPackage lttng-ust # LTTng user space tracing libraries for LTTng
